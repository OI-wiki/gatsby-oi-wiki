...
[父级相对目录-数学简介](../index) [父级相对目录-数学简介](../index) [父级相对目录-数学简介](../index) [父级相对目录-数学简介](../index) [父级相对目录-数学简介](../index) [父级相对目录-数学简介](../index) [父级相对目录-数学简介](../index) [父级相对目录-数学简介](../index) [父级相对目录-数学简介](../index) [父级相对目录-数学简介](../index) [父级相对目录-数学简介](../index) [父级相对目录-数学简介](../index) [父级相对目录-数学简介](../index)
...
$$
f(x) = a_0 + a_1x + a_2x^2+a_3x^3+a_4x^4+a_5x^5+a_6x^6+a_7x^7a_0 + a_1x + a_2x^2+a_3x^3+a_4x^4+a_5x^5+a_6x^6+a_7x^7a_0 + a_1x + a_2x^2+a_3x^3+a_4x^4+a_5x^5+a_6x^6+a_7x^7
$$
