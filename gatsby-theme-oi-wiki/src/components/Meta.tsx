				...
				<div className={classes.meta}>
					{props.authors && (
						<Typography gutterBottom>
							...
							{uniq(
								props.authors.split(',').map((v) => v.trim())
							).map((name) => (
								<Author key={name} name={name} />
							))}
						</Typography>
					)}
					<Typography gutterBottom>
					...
					<Typography>
						<span>
							...
							{' 本页面的全部内容在 '}
							<strong>
								<SmartLink href="https://creativecommons.org/licenses/by-sa/4.0/deed.zh">
									CC BY-SA 4.0
								</SmartLink>
								{' 和 '}
								<SmartLink href="https://github.com/zTrix/sata-license">
									SATA
								</SmartLink>
							</strong>
							{' 协议之条款下提供，附加条款亦可能应用'}
