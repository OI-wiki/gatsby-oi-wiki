...
const Playground: React.FC<PageProps<unknown, unknown, PlaygroundLocationState>> = ({ location }) => {
  ...
  return (
    <Layout location={location} title="Playground" noComment noEdit noToc noMeta overflow>
      <Grid container spacing={3} alignItems="center">
        <Grid item>
          <ButtonGroup>
            ...
            >
              运行
              {waiting && <CircularProgress className={classes.progress} color="secondary" size={24} />}
            </Button>
          </ButtonGroup>
        </Grid>
        <Grid item>
      ...
      <Grid container spacing={3} className={classes.editorContainer} alignItems="stretch">
      ...
      <div className={classes.footer}>
        <Link className={classes.footerLink} href="https://duck.ac/" underline="none" target="_blank" variant="h6">
          {'Powered by '}
